...
import { AgentVisiteurRoutingModule } from './agent-visiteur-routing.module';
...
@NgModule({
    ...
    declarations: [AgentVisiteurComponent,AgentVisiteurFormComponent]
})
export class AgentVisiteursModule { }
