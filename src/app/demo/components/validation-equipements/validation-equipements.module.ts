...
import { ValidationEquipementsRoutingModule } from './validation-equipements-routing.module';
...
@NgModule({
    imports: [
         ...
         CommonModule, // Use CommonModule for feature modules
                 ...
                 PanelMenuModule,
                 ButtonModule,
                 ValidationEquipementsRoutingModule,
                 ProgressBarModule,
                 ToastModule,
                 PanelModule,
                TagModule,
    ...
    declarations: [ValidationEquipementsComponent]
})
export class ValidationEquipementsModule { }
